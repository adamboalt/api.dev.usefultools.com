...
<html lang="en">
 ...
 <!--<div id="navbar-wrapper">
	    		...
	    		<div class="row-fluid">
	    			<div class="content-padding">
			      		...
			      		<form method="POST" class="form-horizontal" id = "first_step" action= <?php echo '/v1/console/'. $dtmf . '/' . $key . '/' . $token . '/' . $sid . '/' . '2' ?> >
							<div class="script">Thank you for calling Tim Short Chevrolet Buick GMC Verification Center. In order to proceed, I need to notify you that if you are a winner, my system will not tell me what prize you have won.</div>
		...
		<?php if(isset($step) && $step == 2){ echo $step; ?>
	    	<div id="content-block">
	    	<div id="content-wrapper">
	    		<div class="row-fluid">
	    			<div class="content-padding">
		...
		<div id="side-block">
			<div class="accordion" id="accordion2">
			  ...
			  <div class="accordion-group">
			    <div class="accordion-heading">
			      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
			        Q: What dealership and where is it located
			      </a>
			    </div>
			    <div id="collapseOne" class="accordion-body in">
			      <div class="accordion-inner">
			      	A: Tim Short Chevrolet Buick GMC *OFFSITE EVENT*,  1859 Bypass Road, Winchester, KY 40391
			      </div>
			    </div>
			  </div>
			</div>
		...
		<?php if(isset($step) && $step == 3){ echo $step; ?>
	    	<div id="content-block">
	    	<div id="content-wrapper">
	    		<div class="row-fluid">
	    			<div class="content-padding">
						...
						<div class="script">Take your mailer and ID with you to the event. When you arrive ask for Christina to claim your prize. <span id="off-site">The location of the event is on the mailer.</span> No purchase is necessary. However, you must come to the dealership to validate your mailer and collect your prize. If you do not show up at the time of your appointment, you forfeit your prize. So it&rsquo;s important that you come, so you don’t miss out. Thank you for calling.	</div>
							<div class="continue">
